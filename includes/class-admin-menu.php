			...
			array(
				...
				'strings'        => array(
					...
					'loadingMessages' => array(
						...
						__( '📰 Artikel scannen...', 'zw-ttvgpt' ),
						__( '✨ AI verwerkt...', 'zw-ttvgpt' ),
						__( '🔍 Kernpunten vinden...', 'zw-ttvgpt' ),
						__( '📝 Samenvatten...', 'zw-ttvgpt' ),
						__( '🧠 Optimaliseren...', 'zw-ttvgpt' ),
						__( '🎨 Finetunen...', 'zw-ttvgpt' ),
						__( '🌟 Bijna klaar...', 'zw-ttvgpt' ),
					),
				),
			)
		);
